"""This file contains functions to initialise a default namespace containing the commonly used
variables and the operator precedence table."""
import string
...
def default_namespace():
    ...
    Attributes:
        ...
        Functions: trigonometricFunction, hyperbolicFunction, elementaryFunction, setFunction,
        integrationFunction, probabilityFunction, arithmeticFunction, vectorSpaceFunction
    ...
    return dict(alphaNumeric=list(string.digits) + list(string.ascii_lowercase) + list(string.ascii_uppercase),
                greekAlphabet=['alpha', 'beta', 'chi', 'delta', 'digamma', 'epsilon', 'eta',
                               'gamma', 'iota', 'kappa', 'lambda', 'mu', 'nu', 'omega', 'phi',
                               'pi', 'psi', 'rho', 'sigma', 'tau', 'theta', 'upsilon',
                               'varepsilon', 'varkappa', 'varphi', 'varpi', 'varrho', 'varsigma',
                               'vartheta', 'xi', 'zeta', 'Delta', 'Gamma', 'Lambda', 'Omega', 'Phi',
                               'Pi', 'Psi', 'Sigma', 'Theta', 'Upsilon', 'Xi', 'mho', 'nabla'],
                trigonometricFunction=['sin', 'cos', 'tan', 'sec', 'csc', 'cot', 'arcsin', 'arccos',
                                       'arctan', 'arcsec', 'arccsc', 'arccot'],
                hyperbolicFunction=['sinh', 'cosh', 'tanh', 'sech', 'csch', 'coth', 'arsinh',
                                    'arcosh', 'artanh', 'arsech', 'arcsch', 'arcoth'],
